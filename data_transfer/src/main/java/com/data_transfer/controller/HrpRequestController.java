package com.data_transfer.controller;
...
import com.data_transfer.models.HipRequest;
import com.data_transfer.models.HiuNotification;
...
public class HrpRequestController {
 ...
 //hrp request to request the health data
    ...
    public String createcHiprequest(@RequestBody HipRequest sample) {
        HttpHeaders headers = new HttpHeaders();
        headers.setAccept(Arrays.asList(MediaType.APPLICATION_JSON));
        headers.setBearerAuth(accessToken);
        headers.set("X-HIM-ID","HIPAMAN");
